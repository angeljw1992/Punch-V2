...
<div class="card">
    <div class="card-header">
        <h3>Justificación de falta de Marcación</h3>
    </div>
    <div class="card-body">
                ...
                <div class="row">
					<div class="col-lg-4 col-md-4 col-sm-12">
						<div class="form-group">
							...
							?>
							<input type="date" class="form-control" name="date" id="date" value="{{ old('date', '') }}" min="{{ $yesterday }}" max="{{ $today }}" required>
						</div>
					</div>
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        <div class="form-group">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        <div class="form-group">
                            ...
                            <select name="excuse" id="excuse" class="form-control" required>
